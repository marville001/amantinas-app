        ...
        "
            ...
            <div className="flex  space-y-2 my-4 justify-center">
                <button
                    ...
                    className="disabled:opacity-50 disabled:cursor-not-allowed uppercase px-16 tracking-wider py-2
                     bg-dark-blue-color text-white text-lg rounded-md mt-8 flex items-center
